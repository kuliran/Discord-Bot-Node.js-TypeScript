...
exports.init = init;
async function init(client, commandPaths, settings) {
    ...
    client.on("interactionCreate", (interaction) => {
        ...
        if (!commandModule)
            return;
        if (!canBeRan(interaction, commandModule, settings))
            return;
        try {
...
function canBeRan(interaction, commandModule, settings) {
    if (!commandModule.validations)
        return true;
